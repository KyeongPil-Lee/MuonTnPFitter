...
private:
  void ProducePlot_GivenVar( TString var, Bool_t isZoomInPlot = kFALSE )
  {
    ...
    GraphCanvaswGivenRatio *canvasRatio = new GraphCanvaswGivenRatio(canvasName, 0, 0);
    if( var == "pt" ) canvasRatio->RemovePointInRatio_BelowThreshold( tnpGraph_2016->ptMin_ ); // -- it shoule come early

    canvasRatio->Register(tnpGraph_2016->g_eff_, tnpGraph_2016->legendInfo_, kBlue);
    canvasRatio->Register(tnpGraph_2017->g_eff_, tnpGraph_2017->legendInfo_, kRed);
    canvasRatio->Register(tnpGraph_2018->g_eff_, tnpGraph_2018->legendInfo_, kBlack);
    ...
    canvasRatio->RegisterRatioGraph( tnpGraph_2016->g_eff_, tnpGraph_2016MC->g_eff_, kBlue);
    canvasRatio->RegisterRatioGraph( tnpGraph_2017->g_eff_, tnpGraph_2017MC->g_eff_, kRed);
    canvasRatio->RegisterRatioGraph( tnpGraph_2018->g_eff_, tnpGraph_2018MC->g_eff_, kBlack);
    ...
    canvasRatio->SetTitle( titleX, titleY, "Data/MC");
    ...
    canvasRatio->RegisterLatex( 0.13, 0.96, "#font[62]{CMS}" );
    canvasRatio->RegisterLatex( 0.44, 0.96, "#font[42]{#scale[0.45]{35.9 fb^{-1} (2016), 38.0 fb^{-1} (2017), 59.7 fb^{-1} (2018) (13 TeV)}}");
    ...
    if( effType_.Contains("IsoMu24_from") )
      canvasRatio->RegisterLatex( 0.16, 0.91, "#font[42]{#scale[0.7]{Isolated single #mu trigger with p_{T} > 24 GeV}}");
