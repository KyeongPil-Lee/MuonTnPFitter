...
void DrawPlot(TString effType, TString var, Bool_t isZoomInPlot = kFALSE)
{
  ...
  TString fileName_2 = TString::Format("%s_RunBv1/ROOTFile_EfficiencyGraphs.root", triggerName.Data());
  TString fileName_3 = TString::Format("%s_RunBv2/ROOTFile_EfficiencyGraphs.root", triggerName.Data());
  ...
  canvasRatio->Register(g_2, "RunB-v1", kGreen+2);
  canvasRatio->Register(g_3, "RunB-v2", kBlue);
