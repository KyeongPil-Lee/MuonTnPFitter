...
void DrawPlot(TString effType, TString var, Bool_t isZoomInPlot = kFALSE)
{
  ...
  TString fileName_2 = TString::Format("%s_RunCv1/ROOTFile_EfficiencyGraphs.root", triggerName.Data());
  ...
  canvasRatio->Register(g_2, "RunC-v1", kGreen+2);
