...
void DrawPlot(TString effType, TString var, Bool_t isZoomInPlot = kFALSE)
{
  TString fileName_1 = "./IsoMu24_Default_v01/ROOTFile_EfficiencyGraphs.root";
  TString fileName_2 = "./IsoMu24_kBMTF_v01/ROOTFile_EfficiencyGraphs.root";
  ...
  canvasRatio->Register(g_1, "Default (Run 324201)", kBlack);
  canvasRatio->Register(g_2, "k-BMTF (Run 324202)", kBlue);
  ...
  canvasRatio->SetTitle( titleX, titleY, "k-BMTF/Default");
  canvasRatio->SetLegendPosition( 0.50, 0.32, 0.97, 0.45 );
...
// void HotFix( TGraphAsymmErrors *g, TString effType, TString var )
// {
//   if( (effType == "IsoMu24_from_Tight2012_and_dBeta_015" && var == "vtx") ||
//       (effType == "IsoMu24_from_L1SingleMu22_and_Tight2012_and_dBeta_015" && var == "vtx") ||
//       (effType == "L1SingleMu22_from_Tight2012_and_dBeta_015" && var == "vtx") )
