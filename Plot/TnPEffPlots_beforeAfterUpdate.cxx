...
void TnPEffPlots_beforeAfterUpdate()
{
...
void DrawPlot(TString effType, TString var, Bool_t isZoomInPlot = kFALSE)
{
  ...
  TString fileName_1 = TString::Format("%s_beforeUpdate/ROOTFile_EfficiencyGraphs.root", triggerName.Data());
  TString fileName_2 = TString::Format("%s_afterUpdate/ROOTFile_EfficiencyGraphs.root", triggerName.Data());
  ...
  canvasRatio->Register(g_1, "Before OI update (Run 322356)", kBlack);
  canvasRatio->Register(g_2, "After OI update (Run 322381)", kBlue);
