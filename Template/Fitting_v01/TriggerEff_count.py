...
print "===================================================================================="
print "This code is for cut & count efficiency measurement (no fitting is performed)"
print "  -> the mass range should be narrow by skimming before running the code"
print "===================================================================================="
...
elif PassingProbe in List_paper: PtMin = 20
else:
    print "PtMin is not set! ... terminate"
    sys.exit()
...
elif PassingProbe in List_paper: PT_BINS.pt = cms.vdouble( 20, 25, 30, 35, 40, 45, 50, 55, 60, 120, 200, 300, 500, 700, 1200 )
...
for ID in IDS:
    ...
    for X,B in ALLBINS:
        ...
        setattr(module.Efficiencies, ID+"_"+X, cms.PSet(
            ...
            BinnedVariables = DEN,
            # BinToPDFmap = cms.vstring(shape) # -- if it is missed, the efficiency is measured by cut & count -> mass range should be set properly (narrow)
        ))
