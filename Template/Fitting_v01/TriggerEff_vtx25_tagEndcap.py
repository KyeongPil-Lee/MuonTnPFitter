...
PT_BINS.tag_nVertices = cms.vdouble(25, 99)
ETA_BINS.tag_nVertices = cms.vdouble(25, 99)
PHI_BINS.tag_nVertices = cms.vdouble(25, 99)
SINGLE_BIN.tag_nVertices = cms.vdouble(25, 99)
...
for ID in IDS:
    ...
    for X,B in ALLBINS:
        ...
        DEN.tag_abseta = cms.vdouble(1.6, 2.4)
